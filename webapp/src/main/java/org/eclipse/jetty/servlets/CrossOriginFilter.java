 ...
 * Notes (DanHaywood):
 * <ul>
 * <li>original source grabbed from <a href="http://dev.eclipse.org/svnroot/rt/org.eclipse.jetty/jetty/trunk/jetty-servlets/src/main/java/org/eclipse/jetty/servlets/CrossOriginFilter.java">this eclipse svn repo</a></li>
 * <li>replaced dependency on org.eclipse.jetty.util.log.Log with slf4j
 * </li>
 * <li>Added support for init-param allowedHeaders = *, which is interpreted as
 * echoing back the requested headers (see <a href="http://stackoverflow.com/a/13147554/56880">this stackoverflow answer</a>
 * </li>
 * </ul>
 * 
...
public class CrossOriginFilter implements Filter
{
    ...
    private final static org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(CrossOriginFilter.class);
    ...
    private boolean allowedHeadersWildcard;
    ...
    public void init(FilterConfig config) throws ServletException
    {
        ...
        allowedHeadersWildcard = "*".equals(allowedHeadersConfig);
    ...
    private void handle(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException
    {
        ...
        if("OPTIONS".equalsIgnoreCase(request.getMethod())) {
            // don't chain, simply respond with success
    ...
    private void handlePreflightResponse(HttpServletRequest request, HttpServletResponse response, String origin)
    {
        ...
        // 5.2.10
        if(allowedHeadersWildcard) {
            response.setHeader(ACCESS_CONTROL_ALLOW_HEADERS_HEADER, request.getHeader(ACCESS_CONTROL_REQUEST_HEADERS_HEADER));
        } else {
