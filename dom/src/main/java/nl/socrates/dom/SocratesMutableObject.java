 ...
 *     column="version")
 * public class MyDomainObject extends SocratesMutableObject {
 *   ...
 * }
 * </pre>
 * 
 ...
 * kept in sync).
 */
public abstract class SocratesMutableObject<T extends SocratesDomainObject<T>>
    extends SocratesDomainObject<T> {

    public SocratesMutableObject(final String keyProperties){
        super(keyProperties);
    }
