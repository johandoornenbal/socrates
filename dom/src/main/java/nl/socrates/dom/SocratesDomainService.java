...
public abstract class SocratesDomainService<T> extends SocratesService<T> {
    private final Class<T> entityType;

    protected SocratesDomainService(
            final Class<? extends SocratesDomainService<T>> serviceType, 
